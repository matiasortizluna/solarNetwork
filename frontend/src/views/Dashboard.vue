          ...
          <div class="card border-success mb-3" style="width: 18rem">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col"><p>20</p></div>
              </div>
              <div class="row">
                <div class="col"><p>Argument X</p></div>
                <div class="col"><p>Value X</p></div>
              </div>
              <div class="row">
                <div class="col"><p>Argument X</p></div>
                <div class="col"><p>Value X</p></div>
            ...
            <div class="card-footer">
              ...
              <div>
                <div class="row">
                  <div class="col">
                    <button type="button" class="btn btn-success">Do</button>
                  </div>
                  <div class="col">
                    <button type="button" class="btn btn-warning">Maybe</button>
                  </div>
                  <div class="col">
                    <button type="button" class="btn btn-danger">Dont</button>
                  </div>
                </div>
              </div>
            </div>
